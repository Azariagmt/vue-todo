  ...
  <div class="hello" deep-purple darken-4>
    ...
    >
      <div class="todo-item-left">
        <v-checkbox type="checkbox" v-model="todo.completed">check</v-checkbox>
        <div
      ...
      <v-btn fab class="remove-item" flat small dark color="pink" @click="removeTodo(index)"><v-icon >delete_outline</v-icon></v-btn>
    </div>
    ...
    <div>
      <v-btn v-if="showClearCompletedvButton" @click="clearCompleted">
        Clear Completed
      </v-btn>
    </div>
