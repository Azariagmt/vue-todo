    ...
    >
      <div class="todo-item-left">
        ...
        <input
          ...
          v-focus
        />
        <input type="datetime-local" v-model="todo.dat">
      </div>
      <v-btn class="remove-item" flat small dark color="pink" @click="removeTodo(index)"><v-icon small>delete_outline</v-icon></v-btn>
    </div>
